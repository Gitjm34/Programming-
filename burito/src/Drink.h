...
// -------------------------------
// class 'Drink', extends 'Decorator'.
// This class is for decorator design pattern.
// -------------------------------
class Drink : public Decorator
{
public:
	...
	//   or NULL.
	Drink(Burito* decoBurito);
	Drink();
	Drink(const Drink &input);
	Drink(Drink &&input);
	virtual Drink& operator=(const Drink& input);
	virtual Drink& operator=(Drink&& input);
	virtual ~Drink();
...
protected:
	...
	//   should be the pointer from the 'new' operator,
	//   or NULL.
	Drink(const Drink &input, Burito* decoBurito);
public:
	// Call constructor,
